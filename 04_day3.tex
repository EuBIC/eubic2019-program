...
\begin{table}[h!]
  ...
  \begin{tabular}{ L{0.25\textwidth} L{0.70\textwidth} }
    ...
    \rowcolor{Goldenrod}  \textbf{Evangelia Petsalaki} (13:30 - 15:30) & SELPHI: using data-driven approaches for analysis of phosphoproteomics datasets \\
    \rowcolor{Goldenrod}  \textbf{Florian Meier} (15:50 - 17:30)       & Advanced data acquisition methods with MaxQuant.Live \\
    \rowcolor{Melon}      \textbf{BSI}                 & PEAKS X: A Complete Solution for Discovery Proteomics with DDA and DIA Support \\
